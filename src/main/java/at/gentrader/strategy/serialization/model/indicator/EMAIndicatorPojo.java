...
@ToString
@NoArgsConstructor
public class EMAIndicatorPojo implements IndicatorPojo, Serializable, AdjustableIndicator {
    ...
    public Indicator toTa4jIndicator(BarSeries series) {
        return new EMAIndicator(this.getParent().toTa4jIndicator(series), barCounts.get(0));
    }
