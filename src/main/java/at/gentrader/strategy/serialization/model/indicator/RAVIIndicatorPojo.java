...
@ToString
@NoArgsConstructor
public class RAVIIndicatorPojo implements IndicatorPojo, Serializable, AdjustableIndicator {
    ...
    public Indicator toTa4jIndicator(BarSeries series) {
        return new RAVIIndicator(this.getParent().toTa4jIndicator(series), barCounts.get(0), barCounts.get(1));
    }
