...
@ToString
@NoArgsConstructor
public class MACDIndicatorPojo implements IndicatorPojo, Serializable, AdjustableIndicator {
    ...
    public Indicator toTa4jIndicator(BarSeries series) {
        return new MACDIndicator(this.getParent().toTa4jIndicator(series), barCounts.get(0), barCounts.get(1));
    }
