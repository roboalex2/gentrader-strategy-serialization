...
@ToString
@NoArgsConstructor
public class StandardDeviationIndicatorPojo implements IndicatorPojo, Serializable, AdjustableIndicator {
    ...
    public Indicator toTa4jIndicator(BarSeries series) {
        return new StandardDeviationIndicator(this.getParent().toTa4jIndicator(series), barCounts.get(0));
    }
