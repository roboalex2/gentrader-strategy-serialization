...
@ToString
@NoArgsConstructor
public class CMOIndicatorPojo implements IndicatorPojo, Serializable, AdjustableIndicator {
    ...
    public Indicator toTa4jIndicator(BarSeries series) {
        return new CMOIndicator(this.getParent().toTa4jIndicator(series), barCounts.get(0));
    }
