...
@ToString
@NoArgsConstructor
public class ROCIndicatorPojo implements IndicatorPojo, Serializable, AdjustableIndicator {
    ...
    public Indicator toTa4jIndicator(BarSeries series) {
        return new ROCIndicator(this.getParent().toTa4jIndicator(series), barCounts.get(0));
    }
